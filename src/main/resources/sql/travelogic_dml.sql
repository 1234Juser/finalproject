...
INSERT INTO tbl_member (member_name, member_id, member_password, member_email, member_phone, member_profileImageUrl, member_registerdate, member_enddate, member_endstatus, social_type, social_account_id, social_account_ci)
VALUES
-- 일반 사용자
...
INSERT INTO tbl_region (region_uid, region_name, region_type) VALUES
    #1
    ('SEOULGYEONGGI', '서울/경기/강원/충청', 'DOMESTIC'),
    #2
    ('BUSANGYEONGSANG', '부산/경상/전라', 'DOMESTIC'),
    #3
    ('JEJU', '제주', 'DOMESTIC'),
    #4
    ('ASIA', '아시아', 'INTERNATIONAL'),
    #5
    ('EUROPE', '유럽', 'INTERNATIONAL'),
    #6
    ('AMERICAS', '아메리카', 'INTERNATIONAL'),
    #7
    ('OCEANIA', '오세아니아', 'INTERNATIONAL'),
    #8
    ('AFRICA', '아프리카', 'INTERNATIONAL');
...
INSERT INTO tbl_city (country_code, city_uid, city_name, region_code) VALUES
#0101
(01, 'SEOUL0101', '서울', 1),
#0102
(01, 'BUSAN0102', '부산', 2),
...
(01, 'JEJU0103', '제주', 3),
#0104
(01, 'GANGNEUNG0104', '강릉', 1),
#0105
(01, 'DAEJEON0105', '대전', 1),
#0106
(01, 'INCHEON0106', '인천', 1),
#0107
(01, 'CHUNCHEON0107', '춘천', 1),
#0108
(01, 'SUWON0108', '수원', 1),
#0109
(01, 'CHEONGJU0109', '청주', 1),
#0110
(01, 'DAEGU0110', '대구', 2),
#0111
(01, 'JEONJU0111', '전주', 2),
#0112
(01, 'GYEONGJU0112', '경주', 2),
#0113
(01, 'GWANGJU0113', '광주', 2),
#0114
(01, 'ULSAN0114', '울산', 2),
...
INSERT INTO tbl_product (
    product_uid, country_code, city_code, theme_code,
...
INSERT INTO tbl_review (member_code, order_code, review_rating, review_content, review_date, review_pic, review_status) VALUES
    ...
    (2, 4, 1, NULL, '2025-04-24 09:15:00', NULL, 'DELETE_BY_ADMIN'),
