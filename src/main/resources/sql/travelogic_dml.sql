...
INSERT INTO tbl_city (city_code, country_code, city_uid, city_name, region_code) VALUES
                                                                                     (0101, 01, 'SEOUL0101', '서울', 1),
                                                                                     (0102, 01, 'BUSAN0102', '부산', 2),
                                                                                     (0103, 01, 'JEJU0103', '제주', 3),
                                                                                     (0104, 01, 'GANGNEUNG0104', '강릉', 1),
                                                                                     (0105, 01, 'DAEJEON0105', '대전', 1),
                                                                                     (0106, 01, 'INCHEON0106', '인천', 1),
                                                                                     (0107, 01, 'CHUNCHEON0107', '춘천', 1),
                                                                                     (0108, 01, 'SUWON0108', '수원', 1),
                                                                                     (0109, 01, 'CHEONGJU0109', '청주', 1),
                                                                                     (0110, 01, 'DAEGU0110', '대구', 2),
                                                                                     (0111, 01, 'JEONJU0111', '전주', 2),
                                                                                     (0112, 01, 'GYEONGJU0112', '경주', 2),
                                                                                     (0113, 01, 'GWANGJU0113', '광주', 2),
                                                                                     (0114, 01, 'ULSAN0114', '울산', 2),
                                                                                     (0201, 02, 'TOKYO0201', '도쿄', 4),
                                                                                     (0301, 03, 'BANGKOK0301', '방콕', 4),
                                                                                     (0401, 04, 'PARIS0401', '파리', 5),
                                                                                     (0501, 05, 'ROME0501', '로마', 5),
                                                                                     (0601, 06, 'NEWYORK0601', '뉴욕', 6),
                                                                                     (0701, 07, 'MALE0701', '말레', 7),
                                                                                     (0801, 08, 'SYDNEY0801', '시드니', 7),
                                                                                     (0901, 09, 'DUBAI0901', '두바이', 4),
                                                                                     (1001, 10, 'CAPE_TOWN1001', '케이프타운', 8);
...
INSERT INTO tbl_product (
    product_code, product_uid, country_code, city_code, theme_code,
    product_title, product_content, product_adult, product_child,
    product_start_date, product_end_date, product_min_participants,
    product_max_participants, product_status, product_thumbnail
) VALUES
      -- 기존 데이터 수정
      (1, 'SEOUL001', 01, 0101, 1, '서울 시티 투어', '서울 시내 관광 투어',
       100000, 50000, '2025-05-01 09:00:00', '2025-05-31 18:00:00',
       1, 30, 'ON_SALE', 'seoul_tour.jpg'),
      (2, 'BUSAN001', 01, 0102, 2, '부산 골프 리조트 투어', '부산 최고의 골프 리조트를 즐기는 패키지',
       250000, 0, '2025-06-01 09:00:00', '2025-06-30 18:00:00',
       2, 20, 'ON_SALE', 'busan_golf.jpg'),
      (3, 'JEJU001', 01, 0103, 3, '제주 크루즈 투어', '제주 해안을 따라 즐기는 럭셔리 크루즈',
       300000, 150000, '2025-07-01 09:00:00', '2025-07-31 18:00:00',
       10, 100, 'ON_SALE', 'jeju_cruise.jpg'),
      (4, 'GANGNEUNG001', 01, 0104, 4, '강릉 키즈 체험 투어', '아이들과 함께하는 해변 체험 프로그램',
       90000, 50000, '2025-06-15 09:00:00', '2025-06-30 18:00:00',
       2, 25, 'ON_SALE', 'gangneung_kids.jpg'),
      (5, 'DAEJEON001', 01, 0105, 5, '대전 허니문 스페셜', '신혼부부를 위한 럭셔리 과학 도시 체험',
       180000, 0, '2025-07-01 09:00:00', '2025-07-15 18:00:00',
       2, 10, 'ON_SALE', 'daejeon_honeymoon.jpg'),
      (6, 'TOKYO001', 02, 0201, 6, '도쿄 시니어 문화 투어', '실버 세대를 위한 편안한 도쿄 여행',
       160000, 0, '2025-06-01 09:00:00', '2025-06-30 18:00:00',
       1, 20, 'ON_SALE', 'tokyo_silver.jpg'),
      (7, 'BANGKOK001', 03, 0301, 1, '방콕 시내 투어', '방콕의 주요 명소를 둘러보는 시내 투어',
       90000, 45000, '2025-06-01 09:00:00', '2025-06-30 18:00:00',
       1, 25, 'ON_SALE', 'bangkok_tour.jpg'),
      (8, 'PARIS001', 04, 0401, 2, '파리 골프 투어', '파리 근교의 프리미엄 골프 코스를 즐기는 투어',
       280000, 0, '2025-07-01 09:00:00', '2025-07-15 18:00:00',
       2, 12, 'ON_SALE', 'paris_golf.jpg'),
      (9, 'ROME001', 05, 0501, 5, '로마 허니문 투어', '역사와 낭만이 가득한 로마에서의 허니문',
       270000, 0, '2025-08-01 09:00:00', '2025-08-31 18:00:00',
       2, 8, 'ON_SALE', 'rome_honeymoon.jpg'),
      (10, 'NEWYORK001', 06, 0601, 6, '뉴욕 실버 시티 투어', '편안하게 즐기는 뉴욕의 시니어 투어',
       200000, 0, '2025-08-01 09:00:00', '2025-08-15 18:00:00',
       1, 15, 'ON_SALE', 'newyork_silver.jpg'),
      -- 추가 더미 데이터
      (11, 'CHUNCHEON001', 01, 0107, 4, '춘천 가족 여행', '춘천의 아름다운 자연을 담은 가족 여행',
       120000, 60000, '2025-05-01', '2025-05-31', 3, 20, 'ON_SALE', 'chuncheon_family.jpg'),
      (12, 'SUWON001', 01, 0108, 3, '수원 역사 탐방', '수원화성을 중심으로 한 역사 여행',
       90000, 70000, '2025-06-01', '2025-06-30', 2, 15, 'ON_SALE', 'suwon_history.jpg'),
      (13, 'CHEONGJU001', 01, 0109, 5, '청주 힐링 여행', '청주의 자연과 문화를 느낄 수 있는 힐링 여행',
       110000, 55000, '2025-07-01', '2025-07-31', 1, 10, 'ON_SALE', 'cheongju_healing.jpg'),
      (14, 'DAEGU001', 01, 0110, 1, '대구 미식 투어', '대구의 다양한 먹거리를 탐방하는 미식 여행',
       100000, 50000, '2025-08-01', '2025-08-31', 2, 20, 'ON_SALE', 'daegu_food.jpg'),
      (15, 'JEONJU001', 01, 0111, 2, '전주 한옥마을 투어', '전주 한옥마을의 전통과 멋을 느낄 수 있는 여행',
       95000, 65000, '2025-09-01', '2025-09-30', 3, 18, 'ON_SALE', 'jeonju_hanok.jpg'),
      (16, 'GYEONGJU001', 01, 0112, 3, '경주 신라 역사 투어', '신라 천년의 역사를 따라가는 경주 여행',
       120000, 80000, '2025-10-01', '2025-10-31', 1, 12, 'ON_SALE', 'gyeongju_history.jpg'),
      (17, 'GWANGJU001', 01, 0113, 5, '광주 예술 여행', '광주의 예술과 문화를 체험하는 특별한 여행',
       105000, 60000, '2025-11-01', '2025-11-30', 2, 15, 'ON_SALE', 'gwangju_art.jpg'),
      (18, 'ULSAN001', 01, 0114, 4, '울산 산업 탐방', '울산의 자동차, 조선 산업 현장을 견학하는 투어',
       130000, 90000, '2025-12-01', '2025-12-31', 5, 25, 'ON_SALE', 'ulsan_industry.jpg'),
      (19, 'TOKYO002', 02, 0201, 1, '도쿄 쇼핑 투어', '도쿄의 다양한 쇼핑 명소를 방문하는 즐거운 투어',
       140000, 70000, '2025-05-01', '2025-05-31', 1, 10, 'ON_SALE', 'tokyo_shopping.jpg'),
      (20, 'BANGKOK002', 03, 0301, 2, '방콕 왕궁 및 사원 투어', '방콕의 화려한 왕궁과 사원을 탐방하는 투어',
       110000, 55000, '2025-06-01', '2025-06-30', 2, 18, 'ON_SALE', 'bangkok_temple.jpg'),
      (21, 'PARIS002', 04, 0401, 3, '파리 미술관 투어', '세계적인 파리 미술관을 방문하는 예술 투어',
       250000, 125000, '2025-07-01', '2025-07-31', 1, 8, 'ON_SALE', 'paris_museum.jpg'),
      (22, 'ROME002', 05, 0501, 1, '로마 고대 유적 투어', '로마의 콜로세움, 포로 로마노 등 고대 유적을 탐험',
       220000, 110000, '2025-08-01', '2025-08-31', 3, 12, 'ON_SALE', 'rome_ancient.jpg'),
      (23, 'NEWYORK002', 06, 0601, 2, '뉴욕 뮤지컬 투어', '브로드웨이 뮤지컬 관람 및 뉴욕 문화 체험',
       280000, 140000, '2025-09-01', '2025-09-30', 1, 10, 'ON_SALE', 'newyork_musical.jpg'),
      (24, 'MALE001', 07, 0701, 4, '몰디브 해양 액티비티', '몰디브의 아름다운 바다에서 즐기는 액티비티 투어',
       350000, 200000, '2025-10-01', '2025-10-31', 4, 15, 'ON_SALE', 'male_activity.jpg'),
      (25, 'SYDNEY001', 08, 0801, 5, '시드니 오페라 하우스 투어', '시드니 오페라 하우스와 하버 브릿지를 탐방',
       200000, 100000, '2025-11-01', '2025-11-30', 2, 10, 'ON_SALE', 'sydney_opera.jpg'),
      (26, 'DUBAI001', 09, 0901, 6, '두바이 럭셔리 쇼핑 투어', '두바이의 럭셔리 쇼핑몰과 랜드마크를 방문',
       300000, 150000, '2025-12-01', '2025-12-31', 3, 12, 'ON_SALE', 'dubai_shopping.jpg'),
      (27, 'CAPETOWN001', 10, 1001, 4, '케이프타운 자연 투어', '케이프타운의 아름다운 자연 경관을 감상',
       220000, 110000, '2025-05-01', '2025-05-31', 2, 8, 'ON_SALE', 'capetown_nature.jpg');
