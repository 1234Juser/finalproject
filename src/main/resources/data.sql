...
INSERT IGNORE INTO tbl_product (
    ...
    ('SEOUL001', 01, 1, 1, '서울 시티 투어', '서울 시내 관광 투어', 100000, 50000, '2025-05-01 09:00:00', '2025-05-31 18:00:00', 1, 30, 'ON_SALE', 'seoul_tour.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'SEOUL', 'South Korea', 'SEOUL, South Korea', ''),
    ('BUSAN001', 01, 2, 2, '부산 골프 리조트 투어', '부산 최고의 골프 리조트를 즐기는 패키지', 250000, 0, '2025-06-01 09:00:00', '2025-06-30 18:00:00', 2, 20, 'ON_SALE', 'busan_golf.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'BUSAN', 'South Korea', 'BUSAN, South Korea', ''),
    ('JEJU001', 01, 3, 3, '제주 크루즈 투어', '제주 해안을 따라 즐기는 럭셔리 크루즈', 300000, 30000, '2025-07-01 09:00:00', '2025-07-31 18:00:00', 10, 100, 'ON_SALE', 'jeju_cruise.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'JEJU', 'South Korea', 'JEJU, South Korea', ''),
    ('GANGNEUNG001', 01, 4, 4, '강릉 키즈 체험 투어', '아이들과 함께하는 해변 체험 프로그램', 90000, 12900, '2025-06-15 09:00:00', '2025-06-30 18:00:00', 2, 25, 'ON_SALE', 'gangneung_kids.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'GANGNEUNG', 'South Korea', 'GANGNEUNG, South Korea', ''),
('DAEJEON001', 01, 5, 5, '대전 허니문 스페셜', '신혼부부를 위한 럭셔리 과학 도시 체험', 180000, 0, '2025-07-01 09:00:00', '2025-07-15 18:00:00', 2, 10, 'ON_SALE', 'daejeon_honeymoon.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'DAEJEON', 'South Korea', 'DAEJEON, South Korea', ''),
('TOKYO001', 02, 15, 6, '도쿄 시니어 문화 투어', '실버 세대를 위한 편안한 도쿄 여행', 160000, 0, '2025-06-01 09:00:00', '2025-06-30 18:00:00', 1, 20, 'ON_SALE', 'tokyo_silver.jpg', 'TOUR', 0, 4, 'INTERNATIONAL', 'TOKYO', 'Japan', 'TOKYO, Japan', ''),
('BANGKOK001', 03, 16, 1, '방콕 시내 투어', '방콕의 주요 명소를 둘러보는 시내 투어', 780000, 99000, '2025-06-01 09:00:00', '2025-06-30 18:00:00', 1, 25, 'ON_SALE', 'bangkok_tour.jpg', 'TOUR', 0, 4, 'INTERNATIONAL', 'BANGKOK', 'Thailand', 'BANGKOK, Thailand', ''),
('PARIS001', 04, 17, 2, '파리 골프 투어', '파리 근교의 프리미엄 골프 코스를 즐기는 투어', 400000, 0, '2025-07-01 09:00:00', '2025-07-15 18:00:00', 2, 12, 'ON_SALE', '/img/empty/empty-list.jpeg', 'TOUR', 0, 5, 'INTERNATIONAL', 'PARIS', 'France', 'PARIS, France', ''),
('ROME001', 05, 18, 5, '로마 허니문 투어', '역사와 낭만이 가득한 로마에서의 허니문', 270000, 0, '2025-08-01 09:00:00', '2025-08-31 18:00:00', 2, 8, 'ON_SALE', 'rome_honeymoon.jpg', 'TOUR', 0, 5, 'INTERNATIONAL', 'ROME', 'Italy', 'ROME, Italy', ''),
('NEWYORK001', 06, 19, 6, '뉴욕 실버 시티 투어', '편안하게 즐기는 뉴욕의 시니어 투어', 2500000, 0, '2025-08-01 09:00:00', '2025-08-15 18:00:00', 1, 15, 'ON_SALE', 'newyork_silver.jpg', 'TOUR', 0, 6, 'INTERNATIONAL', 'NEWYORK', 'United States', 'NEWYORK, United States', ''),
('CHUNCHEON001', 01, 7, 4, '춘천 가족 여행', '춘천의 아름다운 자연을 담은 가족 여행', 99000, 29000, '2025-05-01 00:00:00', '2025-05-31 00:00:00', 3, 20, 'ON_SALE', 'chuncheon_family.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'CHUNCHEON', 'South Korea', 'CHUNCHEON, South Korea', ''),
('SUWON001', 01, 8, 3, '수원 역사 탐방', '수원화성을 중심으로 한 역사 여행', 50000, 10000, '2025-06-01 00:00:00', '2025-06-30 00:00:00', 2, 15, 'ON_SALE', 'suwon_history.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'SUWON', 'South Korea', 'SUWON, South Korea', ''),
('CHEONGJU001', 01, 9, 5, '청주 힐링 여행', '청주의 자연과 문화를 느낄 수 있는 힐링 여행', 30000, 0, '2025-07-01 00:00:00', '2025-07-31 00:00:00', 1, 10, 'ON_SALE', 'cheongju_healing.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'CHEONGJU', 'South Korea', 'CHEONGJU, South Korea', ''),
('DAEGU001', 01, 10, 1, '대구 미식 투어', '대구의 다양한 먹거리를 탐방하는 미식 여행', 70000, 0, '2025-08-01 00:00:00', '2025-08-31 00:00:00', 2, 20, 'ON_SALE', 'daegu_food.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'DAEGU', 'South Korea', 'DAEGU, South Korea', ''),
('JEONJU001', 01, 11, 2, '전주 한옥마을 투어', '전주 한옥마을의 전통과 멋을 느낄 수 있는 여행', 60000, 0, '2025-09-01 00:00:00', '2025-09-30 00:00:00', 3, 18, 'ON_SALE', 'jeonju_hanok.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'JEONJU', 'South Korea', 'JEONJU, South Korea', ''),
('GYEONGJU001', 01, 12, 3, '경주 신라 역사 투어', '신라 천년의 역사를 따라가는 경주 여행', 28000, 8000, '2025-10-01 00:00:00', '2025-10-31 00:00:00', 1, 12, 'ON_SALE', 'gyeongju_history.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'GYEONGJU', 'South Korea', 'GYEONGJU, South Korea', ''),
('GWANGJU001', 01, 13, 5, '광주 예술 여행', '광주의 예술과 문화를 체험하는 특별한 여행', 60000, 0, '2025-11-01 00:00:00', '2025-11-30 00:00:00', 2, 15, 'ON_SALE', 'gwangju_art.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'GWANGJU', 'South Korea', 'GWANGJU, South Korea', ''),
('ULSAN001', 01, 14, 4, '울산 산업 탐방', '울산의 자동차, 조선 산업 현장을 견학하는 투어', 48000, 0, '2025-12-01 00:00:00', '2025-12-31 00:00:00', 5, 25, 'ON_SALE', 'ulsan_industry.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'ULSAN', 'South Korea', 'ULSAN, South Korea', ''),
('TOKYO002', 02, 15, 1, '도쿄 쇼핑 투어', '도쿄의 다양한 쇼핑 명소를 방문하는 즐거운 투어', 600000, 70000, '2025-05-01 00:00:00', '2025-05-31 00:00:00', 1, 10, 'ON_SALE', 'tokyo_shopping.jpg', 'TOUR', 0, 4, 'INTERNATIONAL', 'TOKYO', 'Japan', 'TOKYO, Japan', ''),
('BANGKOK002', 03, 16, 2, '방콕 왕궁 및 사원 투어', '방콕의 화려한 왕궁과 사원을 탐방하는 투어', 1100000, 155000, '2025-06-01 00:00:00', '2025-06-30 00:00:00', 2, 18, 'ON_SALE', 'bangkok_temple.jpg', 'TOUR', 0, 4, 'INTERNATIONAL', 'BANGKOK', 'Thailand', 'BANGKOK, Thailand', ''),
...
('ROME002', 05, 18, 1, '로마 고대 유적 투어', '로마의 콜로세움, 포로 로마노 등 고대 유적을 탐험', 2200000, 210000, '2025-08-01 00:00:00', '2025-08-31 00:00:00', 3, 12, 'ON_SALE', 'rome_ancient.jpg', 'TOUR', 0, 5, 'INTERNATIONAL', 'ROME', 'Italy', 'ROME, Italy', ''),
('NEWYORK002', 06, 19, 2, '뉴욕 뮤지컬 투어', '브로드웨이 뮤지컬 관람 및 뉴욕 문화 체험', 2800000, 140000, '2025-09-01 00:00:00', '2025-09-30 00:00:00', 1, 10, 'ON_SALE', 'newyork_musical.jpg', 'TOUR', 0, 6, 'INTERNATIONAL', 'NEWYORK', 'United States', 'NEWYORK, United States', ''),
('MALE001', 07, 20, 4, '몰디브 해양 액티비티', '몰디브의 아름다운 바다에서 즐기는 액티비티 투어', 850000, 200000, '2025-10-01 00:00:00', '2025-10-31 00:00:00', 4, 15, 'ON_SALE', 'male_activity.jpg', 'TOUR', 0, 4, 'INTERNATIONAL', 'MALE', 'Maldives', 'MALE, Maldives', ''),
('SYDNEY001', 08, 21, 5, '시드니 오페라 하우스 투어', '시드니 오페라 하우스와 하버 브릿지를 탐방', 3500000, 240000, '2025-11-01 00:00:00', '2025-11-30 00:00:00', 2, 10, 'ON_SALE', 'sydney_opera.jpg', 'TOUR', 0, 7, 'INTERNATIONAL', 'SYDNEY', 'Australia', 'SYDNEY, Australia', ''),
...
('SEOUL002', 01, 1, 7, '서울 트레킹 명소 투어', '서울의 아름다운 산과 숲길을 따라 걷는 힐링 트레킹 투어', 87000, 0, '2025-05-01 09:00:00', '2025-05-31 18:00:00', 1, 30, 'ON_SALE', 'seoul_trekking.jpg', 'TOUR', 0, 1, 'DOMESTIC', 'SEOUL', 'South Korea', 'SEOUL, South Korea', ''),
