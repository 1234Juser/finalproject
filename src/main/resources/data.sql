...
INSERT IGNORE INTO tbl_product (
    ...
    city_name, country_name, full_location, product_detail_code) VALUES
                                                                     ('SEOUL001', 01, 1, 1, '결제용테스트', '결제용테스트', 500, 100, '2025-05-01', '2025-08-31', 1, 30, 'ON_SALE', '/static/img/earth.jpg',  0, 1, 'DOMESTIC', 'SEOUL', 'South Korea', 'SEOUL, South Korea', 1),
                                                                     ('SEOUL002', 01, 1, 7, '서울 트레킹 명소 투어', '서울의 아름다운 산과 숲길을 따라 걷는 힐링 트레킹 투어', 500, 100, '2025-05-01', '2025-08-31', 1, 30, 'ON_SALE', '/static/img/product/region1/seoul.jpg', 0, 1, 'DOMESTIC', 'SEOUL', 'South Korea', 'SEOUL, South Korea', 1),
                                                                     ('SEOUL003', 01, 1, 1, '서울 시티 투어', '서울 시내 관광 투어', 101880, 51020, '2025-05-01', '2025-08-25', 1, 30, 'ON_SALE', '/static/img/product/region1/seoul.jpg',  0, 1, 'DOMESTIC', 'SEOUL', 'South Korea', 'SEOUL, South Korea', 1),
                                                                     ('SEOUL004', 01, 1, 11, '서울 힐링 & 전통 문화 체험', '북촌 한옥마을과 남산골 한옥마을에서 즐기는 전통 체험', 71950, 36040, '2025-09-05', '2026-09-07', 2, 10, 'CLOSED', '/static/img/product/region1/seoul.jpg',  0, 1, 'DOMESTIC', 'SEOUL', 'South Korea', 'SEOUL, South Korea', 1),
                                                                     ('SEOUL005', 01, 1, 15, '서울 야경 명소 버스 투어', '서울의 아름다운 야경을 편안하게 감상하는 투어', 67900, 33870, '2025-05-20', '2025-08-20', 5, 30, 'CLOSED', '/static/img/product/region1/seoul.jpg',  0, 1, 'DOMESTIC', 'SEOUL', 'South Korea', 'SEOUL, South Korea', 1),
                                                                     ('SEOUL006', 01, 1, 4, '서울 놀이공원 & 벚꽃 축제 투어', '신나는 놀이기구와 아름다운 벚꽃을 만끽하는 봄 시즌 한정 투어', 91880, 45910, '2025-04-05', '2025-08-07', 5, 30, 'CLOSED', '/static/img/product/region1/seoul.jpg',  0, 1, 'DOMESTIC', 'SEOUL', 'South Korea', 'SEOUL, South Korea', 1),

                                                                     ('BUSAN001', 01, 2, 2, '부산 골프 리조트 투어', '부산 최고의 골프 리조트를 즐기는 패키지', 254870, 149650, '2025-06-01', '2026-06-30', 2, 20, 'ON_SALE', '/static/img/product/region2/busan.jpg', 0, 2, 'DOMESTIC', 'BUSAN', 'South Korea', 'BUSAN, South Korea', 2),
                                                                     ('BUSAN002', 01, 2, 8, '부산 불꽃 축제 & 야경 투어', '부산의 화려한 불꽃 축제와 아름다운 야경을 즐기는 특별한 투어', 127900, 69880, '2025-08-15', '2026-08-15', 2, 20, 'ON_SALE', '/static/img/product/region2/busan.jpg',  0, 2, 'DOMESTIC', 'BUSAN', 'South Korea', 'BUSAN, South Korea', 2),

                                                                     ('JEJU001', 01, 3, 3, '제주 크루즈 투어', '제주 해안을 따라 즐기는 럭셔리 크루즈', 304880, 34910, '2025-07-01', '2026-07-31', 10, 100, 'ON_SALE', '/static/img/product/region3/jeju.jpg',  0, 3, 'DOMESTIC', 'JEJU', 'South Korea', 'JEJU, South Korea', 3),
                                                                     ('JEJU002', 01, 3, 9, '제주 면세점 쇼핑 & 맛집 투어', '제주 면세점에서 쇼핑을 즐기고 현지인 추천 맛집을 탐방하는 투어', 95950, 17880, '2025-07-05', '2026-07-10', 10, 100, 'ON_SALE', '/static/img/product/region3/jeju.jpg',  0, 3, 'DOMESTIC', 'JEJU', 'South Korea', 'JEJU, South Korea', 3),
                                                                     ('JEJU003', 01, 3, 7, '제주 한라산 영실 코스 트레킹 투어', '한라산 영실 코스를 따라 아름다운 기암괴석과 풍경을 감상하는 트레킹 투어', 71880, 39930, '2025-08-01', '2026-08-01', 5, 15, 'ON_SALE', '/static/img/product/region3/jeju.jpg',  0, 3, 'DOMESTIC', 'JEJU', 'South Korea', 'JEJU, South Korea', 3),
                                                                     ('JEJU004', 01, 3, 11, '제주 서부 해안 & 오설록 힐링 투어', '곽지과물 해변, 협재 해변 등 아름다운 서부 해안을 따라 오설록 티 뮤지엄에서 차를 즐기는 힐링 여행', 86900, 21870, '2025-08-20', '2026-08-20', 3, 12, 'ON_SALE', '/static/img/product/region3/jeju.jpg', 0, 3, 'DOMESTIC', 'JEJU', 'South Korea', 'JEJU, South Korea', 3),
                                                                     ('JEJU005', 01, 3, 13, '제주 동굴 & 화산 지형 탐험 투어', '만장굴, 성산일출봉 등 제주의 독특한 화산 지형과 동굴을 탐험하며 자연 역사를 배우는 투어', 91880, 47950, '2025-09-10', '2026-09-10', 4, 18, 'ON_SALE', '/static/img/product/region3/jeju.jpg',  0, 3, 'DOMESTIC', 'JEJU', 'South Korea', 'JEJU, South Korea', 3),
