...
('AUCKLAND001', 17, 37, 1, '오클랜드 스카이 타워 & 하버 브릿지 투어', '오클랜드의 상징 스카이 타워에서 도시 전경을 감상하고 하버 브릿지를 건너는 투어', 120870, 59640, '2025-09-01 10:00:00', '2026-09-01 18:00:00', 2, 10, 'ON_SALE', '/static/img/product/region7/auckland.jpg',  0, 7, 'INTERNATIONAL', 'AUCKLAND', 'New Zealand', '오클랜드의 랜드마크를 경험하세요.', ''),
('AUCKLAND002', 17, 37, 13, '오클랜드 박물관 & 아오테아 광장 투어', '마오리 문화와 뉴질랜드 역사를 전시하는 오클랜드 박물관과 활기찬 아오테아 광장을 방문하는 문화 투어', 95410, 47820, '2025-10-15 10:00:00', '2026-10-15 17:00:00', 3, 15, 'ON_SALE', '/static/img/product/region7/auckland.jpg',  0, 7, 'INTERNATIONAL', 'AUCKLAND', 'New Zealand', '오클랜드의 문화와 역사를 알아보세요.', ''),
