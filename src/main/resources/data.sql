...
('BANGKOK006', 03, 17, 10, '방콕 쿠킹 클래스 & 현지 시장 투어', '태국 전통 음식을 배우고 현지 시장을 체험하는 특별한 투어', 70330, 39880, '2026-02-01 09:00:00', '2026-02-01 16:00:00', 2, 10, 'ON_SALE', '/static/img/product/region4/bangkok.jpg',  0, 4, 'INTERNATIONAL', 'BANGKOK', 'Thailand', 'BANGKOK, Thailand', ''),
...
('BANGKOK008', 03, 17, 1, '방콕 전통 마사지 & 짐 톰슨 하우스 투어', '태국 전통 마사지로 피로를 풀고 아름다운 짐 톰슨 하우스를 방문하는 힐링 투어', 54890, 30210, '2026-01-15 10:00:00', '2026-01-15 17:00:00', 2, 10, 'ON_SALE', '/static/img/product/region4/bangkok.jpg',  0, 4, 'INTERNATIONAL', 'BANGKOK', 'Thailand', 'BANGKOK, Thailand', ''),
...
('SYDNEY005', 08, 22, 12, '시드니 본다이 비치 & 서핑 레슨', '시드니의 대표적인 해변 본다이에서 서핑을 배우고 자유시간을 즐기는 투어', 129910, 75630, '2026-01-10 10:00:00', '2026-01-10 16:00:00', 1, 15, 'ON_SALE', '/static/img/product/region7/sydney.jpg',  0, 7, 'INTERNATIONAL', 'SYDNEY', 'Australia', 'SYDNEY, Australia', ''),
...
('DUBAI004', 09, 23, 1, '두바이 몰 분수 쇼 & 야경 투어', '세계 최대 규모의 두바이 몰 분수 쇼와 화려한 야경을 감상하는 투어', 104940, 65120, '2026-01-05 19:00:00', '2026-01-05 23:00:00', 2, 10, 'ON_SALE', '/static/img/product/region4/dubai.jpg',  0, 4, 'INTERNATIONAL', 'DUBAI', 'United Arab Emirates', 'DUBAI, United Arab Emirates', ''),
('DUBAI005', 09, 23, 10, '두바이 전통 시장 & 향신료 체험 투어', '두바이의 전통 시장을 방문하여 다양한 향신료와 문화를 체험하는 투어', 55230, 29880, '2026-02-10 10:00:00', '2026-02-10 17:00:00', 3, 15, 'ON_SALE', '/static/img/product/region4/dubai.jpg',  0, 4, 'INTERNATIONAL', 'DUBAI', 'United Arab Emirates', 'DUBAI, United Arab Emirates', ''),
...
('CAPETOWN004', 10, 24, 1, '케이프타운 희망봉 & 케이블카 투어', '아프리카 최남단 희망봉을 방문하고 테이블 마운틴 케이블카를 탑승하는 투어', 101500, 59800, '2026-02-01 09:00:00', '2026-02-02 18:00:00', 2, 8, 'ON_SALE', '/static/img/product/region8/capetown.jpg',  0, 8, 'INTERNATIONAL', 'CAPETOWN', 'South Africa', 'CAPETOWN, South Africa', ''),
('CAPETOWN005', 10, 24, 12, '케이프타운 해변 & 해양 스포츠 체험', '케이프타운의 아름다운 해변에서 다양한 해양 스포츠를 즐기는 액티비티 투어', 80370, 49910, '2026-03-10 10:00:00', '2026-03-10 17:00:00', 1, 12, 'ON_SALE', '/static/img/product/region8/capetown.jpg',  0, 8, 'INTERNATIONAL', 'CAPETOWN', 'South Africa', 'CAPETOWN, South Africa', ''),
...
('BEIJING005', 12, 26, 13, '베이징 자금성 & 천단 공원 역사 투어', '중국의 대표적인 황궁 자금성과 하늘에 제사를 지내던 천단 공원을 방문하는 투어', 110270, 55160, '2026-03-01 09:00:00', '2026-03-01 18:00:00', 4, 25, 'ON_SALE', '/static/img/product/region4/beijing.jpg',  0, 4, 'INTERNATIONAL', 'BEIJING', 'China', 'BEIJING, China', ''),
('BEIJING006', 12, 26, 1, '베이징 후통 & 전통 가옥 체험 투어', '베이징의 옛 골목길 후통을 탐험하고 전통 가옥을 방문하여 중국 문화를 체험하는 투어', 90840, 44700, '2026-04-10 10:00:00', '2026-04-10 17:00:00', 2, 15, 'ON_SALE', '/static/img/product/region4/beijing.jpg',  0, 4, 'INTERNATIONAL', 'BEIJING', 'China', 'BEIJING, China', ''),

('SHANGHAI001', 12, 27, 16, '상하이 야경 & 유람선 투어', '황푸 강을 따라 펼쳐지는 상하이의 화려한 야경을 감상하는 로맨틱 투어', 120610, 59890, '2025-06-10 19:00:00', '2025-06-10 22:00:00', 2, 15, 'ON_SALE', '/static/img/product/region4/shanghai.jpeg',  0, 4, 'INTERNATIONAL', 'SHANGHAI', 'China', 'SHANGHAI, China', ''),
...
('HANOI001', 14, 31, 1, '하노이 호안끼엠 호수 & 구시가지 투어', '하노이의 중심 호안끼엠 호수와 전통적인 구시가지를 둘러보는 투어', 65100, 32870, '2026-07-01 09:00:00', '2026-07-01 17:00:00', 4, 20, 'ON_SALE', '/static/img/product/region4/hanoi.jpg',  0, 4, 'INTERNATIONAL', 'HANOI', 'Vietnam', 'HANOI, Vietnam', ''),
('HANOI002', 14, 31, 13, '하노이 문묘 & 민족학 박물관 투어', '베트남 최초의 대학 문묘와 다양한 민족 문화를 전시하는 박물관을 방문하는 교육적인 투어', 72530, 35910, '2026-08-10 10:00:00', '2026-08-10 18:00:00', 3, 15, 'ON_SALE', '/static/img/product/region4/hanoi.jpg',  0, 4, 'INTERNATIONAL', 'HANOI', 'Vietnam', 'HANOI, Vietnam', ''),

('HOCHIMINH001', 14, 32, 13, '호치민 전쟁 박물관 & 통일궁 투어', '베트남 전쟁의 역사를 보여주는 박물관과 남베트남 대통령궁이었던 통일궁 방문', 68920, 33850, '2026-09-01 09:00:00', '2026-09-01 17:00:00', 2, 18, 'ON_SALE', '/static/img/product/region4/hochiminh.jpg',  0, 4, 'INTERNATIONAL', 'HOCHIMINH', 'Vietnam', 'HOCHIMINH', ''),
('HOCHIMINH002', 14, 32, 1, '호치민 벤탄 시장 & 사이공 강 크루즈', '활기 넘치는 벤탄 시장을 둘러보고 사이공 강을 따라 여유로운 크루즈를 즐기는 투어', 75250, 37660, '2026-10-10 18:00:00', '2026-10-10 22:00:00', 1, 10, 'ON_SALE', '/static/img/product/region4/hochiminh.jpg',  0, 4, 'INTERNATIONAL', 'HOCHIMINH', 'Vietnam', 'HOCHIMINH', ''),

('BERLIN001', 15, 33, 13, '베를린 장벽 & 체크포인트 찰리 투어', '냉전 시대의 상징 베를린 장벽과 체크포인트 찰리를 방문하는 역사 투어', 150880, 74730, '2026-11-01 09:00:00', '2026-11-01 17:00:00', 3, 15, 'ON_SALE', '/static/img/product/region5/berlin.jpg', 0, 5, 'INTERNATIONAL', 'BERLIN', 'Germany', 'BERLIN, Germany', ''),
('BERLIN002', 15, 33, 1, '베를린 브란덴부르크 문 & 국회의사당 투어', '베를린의 상징 브란덴부르크 문과 독일 연방 의회 의사당을 방문하는 투어', 130150, 65040, '2026-12-10 10:00:00', '2026-12-10 18:00:00', 2, 12, 'ON_SALE', '/static/img/product/region5/berlin.jpg',  0, 5, 'INTERNATIONAL', 'BERLIN', 'Germany', 'BERLIN, Germany', ''),

('HAMBURG001', 15, 34, 10, '함부르크 항구 & 어시장 투어', '활기 넘치는 함부르크 항구를 둘러보고 싱싱한 해산물을 맛볼 수 있는 어시장 방문', 110620, 54980, '2026-07-05 06:00:00', '2026-07-05 14:00:00', 1, 10, 'ON_SALE', '/static/img/product/region5/hamburg.jpg', 0, 5, 'INTERNATIONAL', 'HAMBURG', 'Germany', 'HAMBURG, Germany', ''),
('HAMBURG002', 15, 34, 1, '함부르크 시청사 & 알스터 호수 투어', '웅장한 함부르크 시청사를 방문하고 아름다운 알스터 호수 주변을 산책하는 투어', 95370, 48110, '2026-08-15 10:00:00', '2026-08-15 17:00:00', 2, 15, 'ON_SALE', '/static/img/product/region5/hamburg.jpg',  0, 5, 'INTERNATIONAL', 'HAMBURG', 'Germany', 'HAMBURG, Germany', ''),

('MUNICH001', 15, 35, 1, '뮌헨 마리엔 광장 & 신/구 시청사 투어', '뮌헨의 중심 마리엔 광장과 아름다운 신/구 시청사를 방문하는 투어', 120900, 59770, '2026-09-05 10:00:00', '2026-09-05 18:00:00', 3, 20, 'ON_SALE', '/static/img/product/region5/munich.jpg', 0, 5, 'INTERNATIONAL', 'MUNICH', 'Germany', 'MUNICH, Germany', ''),
('MUNICH002', 15, 35, 1, '뮌헨 BMW 박물관 & 올림픽 공원 투어', '세계적인 자동차 브랜드 BMW의 역사와 올림픽 공원을 둘러보는 투어', 105450, 52890, '2026-10-20 10:00:00', '2026-10-20 17:00:00', 2, 18, 'ON_SALE', '/static/img/product/region5/munich.jpg',  0, 5, 'INTERNATIONAL', 'MUNICH', 'Germany', 'MUNICH, Germany', ''),

('CAIRO001', 16, 36, 13, '카이로 피라미드 & 스핑크스 투어', '세계적인 불가사의 피라미드와 스핑크스를 방문하는 역사적인 투어', 95650, 47910, '2026-11-01 08:00:00', '2026-11-01 17:00:00', 5, 30, 'ON_SALE', '/static/img/product/region8/cairo.jpg',  0, 8, 'INTERNATIONAL', 'CAIRO', 'Egypt', 'CAIRO, Egypt', ''),
('CAIRO002', 16, 36, 13, '카이로 이집트 박물관 & 나일 강 크루즈', '파라오의 유물을 전시하는 이집트 박물관을 관람하고 나일 강을 따라 유유자적 크루즈를 즐기는 투어', 110330, 55180, '2026-12-15 10:00:00', '2026-12-15 22:00:00', 3, 20, 'ON_SALE', '/static/img/product/region8/cairo.jpg',  0, 8, 'INTERNATIONAL', 'CAIRO', 'Egypt', 'CAIRO, Egypt', ''),

('AUCKLAND001', 17, 37, 1, '오클랜드 스카이 타워 & 하버 브릿지 투어', '오클랜드의 상징 스카이 타워에서 도시 전경을 감상하고 하버 브릿지를 건너는 투어', 120870, 59640, '2026-09-01 10:00:00', '2026-09-01 18:00:00', 2, 10, 'ON_SALE', '/static/img/product/region7/auckland.jpg',  0, 7, 'INTERNATIONAL', 'AUCKLAND', 'New Zealand', '오클랜드의 랜드마크를 경험하세요.', ''),
('AUCKLAND002', 17, 37, 13, '오클랜드 박물관 & 아오테아 광장 투어', '마오리 문화와 뉴질랜드 역사를 전시하는 오클랜드 박물관과 활기찬 아오테아 광장을 방문하는 문화 투어', 95410, 47820, '2026-10-15 10:00:00', '2026-10-15 17:00:00', 3, 15, 'ON_SALE', '/static/img/product/region7/auckland.jpg',  0, 7, 'INTERNATIONAL', 'AUCKLAND', 'New Zealand', '오클랜드의 문화와 역사를 알아보세요.', ''),

('RIO_DE_JANEIRO001', 18, 38, 1, '리우 예수상 & 팡 데 아수카르 투어', '리우의 상징 예수상과 아름다운 설탕빵 산을 방문하는 대표적인 투어', 160500, 79880, '2026-07-01 09:00:00', '2026-07-01 18:00:00', 3, 15, 'ON_SALE', '/static/img/product/region6/rio_de_janeiro.jpg',  0, 6, 'INTERNATIONAL', 'RIO_DE_JANEIRO', 'Brazil', 'RIO_DE_JANEIRO, Brazil', ''),
('RIO_DE_JANEIRO002', 18, 38, 1, '리우 코파카바나 & 이파네마 해변 투어', '세계적으로 유명한 코파카바나와 이파네마 해변을 즐기고 주변을 둘러보는 투어', 120340, 60120, '2026-08-15 10:00:00', '2026-08-15 17:00:00', 2, 20, 'ON_SALE', '/static/img/product/region6/rio_de_janeiro.jpg',  0, 6, 'INTERNATIONAL', 'RIO_DE_JANEIRO', 'Brazil', 'RIO_DE_JANEIRO, Brazil', ''),

('SAO_PAULO001', 18, 39, 14, '상파울루 미술관(MASP) & 이비라푸에라 공원 투어', '남미 최대 규모의 미술관 중 하나인 MASP와 넓고 아름다운 이비라푸에라 공원을 방문하는 문화 휴식 투어', 95770, 48300, '2026-09-05 10:00:00', '2026-09-05 17:00:00', 1, 10, 'ON_SALE', '/static/img/product/region6/sao_paulo.jpg',  0, 6, 'INTERNATIONAL', 'SAO PAULO', 'Brazil', 'SAO PAULO, Brazil', ''),
('SAO_PAULO002', 18, 39, 9, '상파울루 시립 시장 & 파울리스타 거리 투어', '다양한 식료품과 기념품을 판매하는 활기찬 시립 시장과 상파울루의 중심 거리 파울리스타를 둘러보는 투어', 80260, 39750, '2026-10-20 10:00:00', '2026-10-20 16:00:00', 2, 15, 'ON_SALE', '/static/img/product/region6/sao_paulo.jpg',  0, 6, 'INTERNATIONAL', 'SAO PAULO', 'Brazil', 'SAO PAULO, Brazil', ''),

('JAKARTA001', 19, 40, 13, '자카르타 국립 박물관 & 독립 광장 투어', '인도네시아의 역사와 문화를 전시하는 국립 박물관과 자카르타의 중심 독립 광장을 방문하는 투어', 55190, 27930, '2026-11-01 09:00:00', '2026-11-01 17:00:00', 4, 22, 'ON_SALE', '/static/img/product/region4/jakarta.jpg',  0, 4, 'INTERNATIONAL', 'JAKARTA', 'Indonesia', 'JAKARTA, Indonesia', ''),
('JAKARTA002', 19, 40, 13, '자카르타 올드타운 (코타 투아) & 파타힐라 광장 투어', '네덜란드 식민지 시대의 흔적이 남아있는 올드타운과 파타힐라 광장을 둘러보는 역사 문화 투어', 62480, 30880, '2026-12-15 10:00:00', '2026-12-15 16:00:00', 3, 18, 'ON_SALE', '/static/img/product/region4/jakarta.jpg',  0, 4, 'INTERNATIONAL', 'JAKARTA', 'Indonesia', 'JAKARTA, Indonesia', ''),

('LONDON001', 20, 41, 13, '런던 타워 & 타워 브릿지 투어', '런던의 역사적인 왕궁 런던 타워와 상징적인 타워 브릿지를 방문하는 투어', 121450, 71080, '2026-09-01 09:00:00', '2026-09-01 17:00:00', 3, 12, 'ON_SALE', '/static/img/product/region5/london.jpg', 0, 5, 'INTERNATIONAL', 'LONDON', 'United Kingdom', 'LONDON, United Kingdom', ''),
('LONDON002', 20, 41, 13, '런던 버킹엄 궁전 & 웨스트민스터 사원 투어', '영국 왕실의 상징 버킹엄 궁전과 역사적인 웨스트민스터 사원을 방문하는 투어', 102890, 60330, '2026-10-15 10:00:00', '2026-10-15 16:00:00', 2, 10, 'ON_SALE', '/static/img/product/region5/london.jpg',  0, 5, 'INTERNATIONAL', 'LONDON', 'United Kingdom', 'LONDON, United Kingdom', ''),

('MANCHESTER001', 20, 42, 1, '맨체스터 국립 축구 박물관 & 올드 트래포드 투어', '축구 팬이라면 놓칠 수 없는 국립 축구 박물관과 맨체스터 유나이티드의 홈 구장 올드 트래포드 방문', 144170, 72560, '2026-11-01 10:00:00', '2026-11-01 17:00:00', 1, 8, 'ON_SALE', '/static/img/product/region5/manchester.png',  0, 5, 'INTERNATIONAL', 'MANCHESTER', 'United Kingdom', 'MANCHESTER, United Kingdom', ''),
('MANCHESTER002', 20, 42, 13, '맨체스터 과학 산업 박물관 & 존 라이랜즈 도서관 투어', '산업 혁명의 중심지 맨체스터의 과학 기술 역사를 보여주는 박물관과 아름다운 고딕 양식의 도서관 방문', 118600, 59110, '2026-12-10 10:00:00', '2026-12-10 16:00:00', 2, 12, 'ON_SALE', '/static/img/product/region5/manchester.png',  0, 5, 'INTERNATIONAL', 'MANCHESTER', 'United Kingdom', 'MANCHESTER, United Kingdom', ''),

('MEXICO_CITY001', 21, 43, 13, '멕시코시티 소칼로 광장 & 국립 궁전 투어', '멕시코의 중심 소칼로 광장과 웅장한 국립 궁전을 방문하는 역사 문화 투어', 101720, 60880, '2026-09-01 09:00:00', '2026-09-01 17:00:00', 4, 25, 'ON_SALE', '/static/img/product/region6/mexico_city.jpg',  0, 6, 'INTERNATIONAL', 'MEXICO_CITY', 'Mexico', 'MEXICO_CITY, Mexico', ''),
('MEXICO_CITY002', 21, 43, 13, '멕시코시티 테오티우아칸 피라미드 투어', '고대 아즈텍 문명의 거대 유적지 테오티우아칸의 태양의 피라미드와 달의 피라미드를 탐험하는 투어', 122050, 70190, '2026-10-15 08:00:00', '2026-10-15 18:00:00', 3, 20, 'ON_SALE', '/static/img/product/region6/mexico_city.jpg',  0, 6, 'INTERNATIONAL', 'MEXICO_CITY', 'Mexico', 'MEXICO_CITY, Mexico', ''),

('MANILA001', 22, 44, 13, '마닐라 인트라무로스 & 산티아고 요새 투어', '스페인 식민지 시대의 성곽 도시 인트라무로스와 역사적인 산티아고 요새를 탐험하는 투어', 71880, 40300, '2026-07-01 09:00:00', '2026-07-01 17:00:00', 4, 22, 'ON_SALE', '/static/img/product/region4/manila.jpg',  0, 4, 'INTERNATIONAL', 'MANILA', 'Philippines', 'MANILA, Philippines', ''),
('MANILA002', 22, 44, 9, '마닐라 그린벨트 & 보니파시오 글로벌 시티 쇼핑 투어', '마닐라의 현대적인 쇼핑 중심지 그린벨트와 보니파시오 글로벌 시티에서 쇼핑을 즐기는 투어', 64910, 35160, '2026-08-15 10:00:00', '2026-08-15 18:00:00', 3, 20, 'ON_SALE', '/static/img/product/region4/manila.jpg',  0, 4, 'INTERNATIONAL', 'MANILA', 'Philippines', 'MANILA, Philippines', ''),

('CEBU001', 22, 45, 12, '세부 막탄 섬 호핑 & 해양 액티비티 투어', '세부 막탄 섬 주변의 아름다운 섬들을 방문하여 스노클링, 다이빙 등 해양 액티비티를 즐기는 투어', 101250, 59870, '2026-09-05 09:00:00', '2026-09-05 17:00:00', 2, 15, 'ON_SALE', '/static/img/product/region4/cebu.jpg',  0, 4, 'INTERNATIONAL', 'CEBU', 'Philippines', 'CEBU, Philippines', ''),
('CEBU002', 22, 45, 13, '세부 시티 역사 & 문화 유적지 투어', '세부 시티의 마젤란의 십자가, 산토니뇨 성당 등 역사적인 유적지와 문화를 체험하는 투어', 60370, 29940, '2026-10-20 10:00:00', '2026-10-20 16:00:00', 1, 10, 'ON_SALE', '/static/img/product/region4/cebu.jpg',  0, 4, 'INTERNATIONAL', 'CEBU', 'Philippines', 'CEBU, Philippines', ''),

('STOCKHOLM001', 23, 46, 13, '스톡홀름 감라스탄 & 왕궁 투어', '스톡홀름의 구시가지 감라스탄의 좁은 골목길을 탐험하고 스웨덴 왕궁을 방문하는 역사 문화 투어', 159700, 90550, '2026-11-01 09:00:00', '2026-11-01 17:00:00', 3, 12, 'ON_SALE', '/static/img/product/region5/stockholm.jpg', 0, 5, 'INTERNATIONAL', 'STOCKHOLM', 'Sweden', 'STOCKHOLM, Sweden', ''),
('STOCKHOLM002', 23, 46, 13, '스톡홀름 바사 박물관 & 스칸센 야외 박물관 투어', '침몰한 전함 바사를 전시하는 바사 박물관과 스웨덴의 전통 가옥과 동물을 볼 수 있는 스칸센 방문', 134810, 105390, '2026-12-15 10:00:00', '2026-12-15 16:00:00', 2, 10, 'ON_SALE', '/static/img/product/region5/stockholm.jpg',  0, 5, 'INTERNATIONAL', 'STOCKHOLM', 'Sweden', 'STOCKHOLM, Sweden', ''),

('BUENOS_AIRES001', 24, 47, 15, '부에노스아이레스 탱고 & 야경 투어', '탱고의 본고장에서 정열적인 탱고 공연을 관람하고 아름다운 부에노스아이레스의 야경을 감상하는 투어', 161040, 80770, '2026-07-01 19:00:00', '2026-07-01 23:00:00', 2, 10, 'ON_SALE', '/static/img/product/region6/buenos_aries.jpg',  0, 6, 'INTERNATIONAL', 'BUENOS AIRES', 'Argentina', 'BUENOS AIRES, Argentina', ''),
('BUENOS_AIRES002', 24, 47, 14, '부에노스아이레스 라 보카 & 산 텔모 지구 투어', '화려한 색감의 건물들이 인상적인 라 보카 지구와 고풍스러운 산 텔모 지구를 둘러보는 문화 투어', 121880, 69930, '2026-08-15 10:00:00', '2026-08-15 17:00:00', 3, 15, 'ON_SALE', '/static/img/product/region6/buenos_aries.jpg',  0, 6, 'INTERNATIONAL', 'BUENOS AIRES', 'Argentina', 'BUENOS AIRES, Argentina', ''),

('SINGAPORE001', 25, 48, 1, '싱가포르 마리나 베이 샌즈 & 가든스 바이 더 베이 투어', '싱가포르의 대표적인 랜드마크 마리나 베이 샌즈와 아름다운 가든스 바이 더 베이를 방문하는 투어', 184330, 155110, '2026-09-01 10:00:00', '2026-09-01 22:00:00', 2, 10, 'ON_SALE', '/static/img/product/region4/singapore.png',  0, 4, 'INTERNATIONAL', 'SINGAPORE', 'Singapore', 'SINGAPORE, Singapore', ''),
('SINGAPORE002', 25, 48, 12, '싱가포르 센토사 섬 & 유니버설 스튜디오 투어', '다양한 어트랙션과 해변을 즐길 수 있는 센토사 섬과 유니버설 스튜디오를 방문하는 즐거운 투어', 219660, 180490, '2026-10-15 10:00:00', '2026-10-15 19:00:00', 1, 8, 'ON_SALE', '/static/img/product/region4/singapore.png',  0, 4, 'INTERNATIONAL', 'SINGAPORE', 'Singapore', 'SINGAPORE, Singapore', ''),

('ZURICH001', 26, 49, 1, '취리히 호수 & 린덴호프 언덕 투어', '아름다운 취리히 호수에서 유람선을 타고 린덴호프 언덕에서 도시 전경을 감상하는 투어', 181520, 101370, '2026-11-01 10:00:00', '2026-11-01 17:00:00', 3, 12, 'ON_SALE', '/static/img/product/region5/zurich.jpg',  0, 5, 'INTERNATIONAL', 'ZURICH', 'Switzerland', 'ZURICH, Switzerland', ''),
('ZURICH002', 26, 49, 9, '취리히 반호프슈트라세 & 구시가지 투어', '세계적으로 유명한 쇼핑 거리 반호프슈트라세와 매력적인 구시가지를 둘러보는 투어', 149800, 89650, '2026-12-10 10:00:00', '2026-12-10 16:00:00', 2, 10, 'ON_SALE', '/static/img/product/region5/zurich.jpg', 0, 5, 'INTERNATIONAL', 'ZURICH', 'Switzerland', 'ZURICH, Switzerland', '');
